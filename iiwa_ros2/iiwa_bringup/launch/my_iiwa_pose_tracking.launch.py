...
def generate_launch_description():
    ...
    robot_description_semantic_config = load_file("iiwa_description", "moveit2/iiwa14.srdf")
    ...
    servo_yaml = load_yaml("iiwa_description", "moveit2/iiwa_moveit2_pose_tracking_config.yaml")
    servo_params = {"moveit_servo": servo_yaml}

    kinematics_yaml = load_yaml("iiwa_description", "moveit2/kinematics.yaml")
    joint_limits_yaml = {"robot_description_planning": load_yaml("iiwa_description", "moveit2/iiwa_joint_limits.yaml")}

    # RViz
    rviz_config_file = get_package_share_directory("iiwa_description") + "/rviz/iiwa.rviz"
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
    ...
    pose_tracking_node = Node(
        ...
        executable="my_pose_tracking_servo_node",
